...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_0] = LAYOUT(
        ...
        KC_TAB,  KC_MINS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_RGHT, KC_BSPC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, FN_1,
                 KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LEFT, KC_UP,   KC_N,    KC_M,    KC_DOT,  KC_COMM, KC_SLSH, KC_BSLS,
                                   UG_NEXT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  KC_ENT,  KC_DOWN, KC_RSFT, KC_TAB,  KC_MUTE
    ),
    [LAYER_1] = LAYOUT(
                 KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
                 UG_TOGG, UG_NEXT, UG_HUEU, UG_SATU, UG_VALU, KC_BRIU,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_F12,
        KC_CAPS, KC_APP,  UG_PREV, UG_HUED, UG_SATD, UG_VALD, KC_BRID, KC_HOME, KC_DEL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                 KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_END,  KC_PGUP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
